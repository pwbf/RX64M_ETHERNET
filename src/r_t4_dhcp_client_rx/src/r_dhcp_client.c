...
******************************************************************************
* Copyright (C) 2011(2015). Renesas Technology Corp., All Rights Reserved.
*******************************************************************************
...
*         : 24.02.2015 1.03    Fixed include header file.
******************************************************************************/
...
#include "r_t4_dhcp_client_rx_config.h"
#include "r_t4_dhcp_client_rx_if.h"
#include "r_dhcp_client.h"
#if (defined(BSP_MCU_RX64M) || defined(BSP_MCU_RX71M)) /* for FIT system */
#include "r_ether_rx_if.h" 
#else /* for non-FIT system (RX63N, RX62N) */
#include "r_ether.h" 
#endif
