...
#define MY_IP_ADDR0     0,0,0,0            /* Local IP address  */
#define GATEWAY_ADDR0   0,0,0,0                /* Gateway address (invalid if all 0s) */
#define SUBNET_MASK0    0,0,0,0          /* Subnet mask  */
// #define MY_IP_ADDR0     10,0,0,130            /* Local IP address  */
// #define GATEWAY_ADDR0   10,0,0,1                /* Gateway address (invalid if all 0s) */
// #define SUBNET_MASK0    255,255,255,0          /* Subnet mask  */

#define MY_IP_ADDR1     10,0,0,131           /* Local IP address  */
#define GATEWAY_ADDR1   10,0,0,1                /* Gateway address (invalid if all 0s) */
...
#define MY_MAC_ADDR0    0x48,0x0C,0xA7,0xFE,0xDC,0xBA
